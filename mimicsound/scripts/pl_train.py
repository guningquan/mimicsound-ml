...
from mimicsound.pl_utils.pl_train_utils import train, eval
from mimicsound.pl_utils.pl_data_utils import json_to_config
import torch
import numpy as np
import mimicsound
...
def main(args):
    ...
    if args.name is not None and args.description is not None:
        base_output_dir = os.path.dirname(mimicsound.__file__)
