...
EXTRINSICS_RIGHT = EXTRINSICS["rsOct10"]["right"]
EXTRINSICS_LEFT = EXTRINSICS["rsOct10"]["left"]
...
def evaluate_high_level_policy(
    ...
    for i, data in enumerate(data_loader):
        ...
        for b in range(B):
            ...
            if isinstance(model, MimicSound) or isinstance(model, ACT):
                if type == "robot":
            ...
            if isinstance(model, MimicSound) and type == "robot":
