...
EXTRINSICS = {
    "rsOct10": {
        "left": np.array(
                   [[ 0.99873167,  0.04049189,  0.02992421,  0.43864564],
       [ 0.03943169, -0.99860176,  0.0352089 , -0.0557944 ],
       [ 0.03130804, -0.03398429, -0.99893187,  0.76471282],
       [ 0.        ,  0.        ,  0.        ,  1.        ]]
       ),
       "right": np.array(
      [[-0.99890839, -0.02622229,  0.03865786,  0.45366011],
       [-0.02792749,  0.99863003, -0.04425068,  0.0580247 ],
       [-0.03744454, -0.045282  , -0.99827223,  0.78997636],
       [ 0.        ,  0.        ,  0.        ,  1.        ]]
       )
    },
    "rsOct10L": np.array(  [[ 0.99873167,  0.04049189,  0.02992421,  0.43864564],
       [ 0.03943169, -0.99860176,  0.0352089 , -0.0557944 ],
       [ 0.03130804, -0.03398429, -0.99893187,  0.76471282],
       [ 0.        ,  0.        ,  0.        ,  1.        ]]),
    "rsOct10R": np.array([[-0.99890839, -0.02622229,  0.03865786,  0.45366011],
       [-0.02792749,  0.99863003, -0.04425068,  0.0580247 ],
       [-0.03744454, -0.045282  , -0.99827223,  0.78997636],
       [ 0.        ,  0.        ,  0.        ,  1.        ]])}
...
class AlohaFK:
    def __init__(self):
        urdf_path = os.path.join(
            os.path.dirname(mimicsound.__file__), "resources/model.urdf"
        )
...
def interpolate_arr(v, seq_length):  # @gnq TODO: check this
    """
    v: (B, T, D)
    seq_length: int
    """
    ...
    if v.shape[1] == seq_length:
        return v  # Fixed bug: return v instead of None
