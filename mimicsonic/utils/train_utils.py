...
from mimicsonic.utils.dataset import PlaydataSequenceDataset
from robomimic.envs.env_base import EnvBase
from robomimic.envs.wrappers import EnvWrapper

import mimicsonic
from mimicsonic.algo import RolloutPolicy
...
def get_exp_dir(config, auto_remove_exp_dir=False, rank=0):
    ...
    if not os.path.isabs(base_output_dir):
        ...
        base_output_dir = os.path.join(mimicsonic.__path__[0], base_output_dir)
