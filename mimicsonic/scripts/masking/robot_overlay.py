...
import cv2
from mimicsonic.utils.mimicsonicUtils import nds, ee_pose_to_cam_frame, EXTRINSICS, REALSENSE_INTRINSICS, cam_frame_to_cam_pixels
...
def main(args):
    ...
    arm = args.arm
    chain = pk.build_serial_chain_from_urdf(open("/mimicsonic/resources/model.urdf").read(), "vx300s/ee_gripper_link")
