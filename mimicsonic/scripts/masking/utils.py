...
from mimicsonic.utils.mimicsonicUtils import AlohaFK, ee_pose_to_cam_pixels, REALSENSE_INTRINSICS, EXTRINSICS, ee_pose_to_cam_frame, cam_frame_to_cam_pixels, draw_dot_on_frame
import cv2
import inspect
...
class SAM:
    def __init__(self):
        sam2_checkpoint = os.path.join(
            os.path.dirname(mimicsonic.__file__), "resources/sam2.1_hiera_tiny.pt"
        )
