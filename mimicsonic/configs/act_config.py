...
from mimicsonic.configs.base_config import BaseConfig
...
class MimicSonicConfig(ACTConfig):
    ALGO_NAME = "mimicsonic"

    def train_config(self):
        """
        BC algorithms don't need "next_obs" from hdf5 - so save on storage and compute by disabling it.
        """
        super(MimicSonicConfig, self).train_config()
    ...
    def observation_config(self):
        super(MimicSonicConfig, self).observation_config()
    ...
    def algo_config(self):
        super(MimicSonicConfig, self).algo_config()
        self.algo.sp.hand_lambda = 1.0
    
    def meta_config(self):
        super(MimicSonicConfig, self).meta_config()
        print("=== MimicSonicConfig.meta_config() called ===")
        ...
        print("=== MimicSonicConfig.meta_config() finished ===")
