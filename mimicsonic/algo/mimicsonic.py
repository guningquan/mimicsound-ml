...
from mimicsonic.algo import register_algo_factory_func, PolicyAlgo
...
from mimicsonic.models.act_nets import Transformer, StyleEncoder
from mimicsonic.models.audio_nets import create_ast_encoder
from mimicsonic.utils.audio_utils import generate_audio_data_for_batch, get_audio_feature_dim

from robomimic.models.transformers import PositionalEncoding

import robomimic.models.base_nets as BaseNets
import mimicsonic.models.policy_nets as PolicyNets
import robomimic.utils.tensor_utils as TensorUtils
import robomimic.utils.obs_utils as ObsUtils

import json

from mimicsonic.algo.act import ACT, ACTModel
...
@register_algo_factory_func("mimicsonic")
def algo_config_to_class(algo_config):
    ...
    """
    algo_class, algo_kwargs = MimicSonic, {}
    return algo_class, algo_kwargs


class MimicSonicModel(ACTModel):
    def __init__(
            self,
            backbones,
            transformer,
    ...
    def _forward(self, qpos, actions, image, encoder_action_proj=None, encoder_joint_proj=None, transformer_input_proj=None, action_head=None, camera_names=None, env_state=None, is_pad=None, aux_action_head=None, audio=None, modality=None):
        """
        Custom forward method for MimicSonicModel with audio support.
        """
